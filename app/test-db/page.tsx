    ...
    <div className="p-8">
      ...
      {error && (
        <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded mb-4">
          ...
          <p>{error}</p>
          <p className="mt-2 text-xs italic">Asegúrate de haber puesto tu ANON KEY real en el archivo .env</p>
        </div>
      )}

      {!error && data.length === 0 && (
        <p className="text-gray-500">Cargando datos o tabla vacía...</p>
      )}
