    ...
    <div className="max-w-4xl mx-auto py-12 px-6 animate-in fade-in duration-700">
      ...
      <div className="bg-card border border-border rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed text-sm md:text-base">
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">1. Acceptance of the Agreement</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">2. User Accounts & Security</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">3. Fair Play Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">4. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">5. Service Availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">6. Limitation of Liability</h2>
            <p>
