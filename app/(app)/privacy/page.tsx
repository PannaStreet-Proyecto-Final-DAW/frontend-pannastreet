...
export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 animate-in fade-in duration-700">
      <Link 
        href="/games" 
        className="inline-flex items-center gap-2 text-white hover:text-primary transition-colors mb-8 text-sm font-bold"
      >
      ...
      <div className="bg-card border border-border rounded-[2rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
        ...
        <h1 className="text-3xl md:text-4xl font-black italic uppercase text-primary mb-10 tracking-tighter leading-none">
          Privacy Policy
        </h1>
        
        <div className="space-y-10 text-muted-foreground leading-relaxed text-sm md:text-base">
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">Information We Collect</h2>
            <p className="mb-3">
            ...
            <ul className="list-disc pl-6 space-y-1.5">
              ...
              <li>Game Progress: Scores, streak data, and league memberships.</li>
              <li>Preferences: Your selected theme (Light/Dark) and notification settings.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">How We Use Your Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">Data Security & Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">Cookie Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">Your Data Rights</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-primary mb-3 uppercase italic tracking-tight">Changes to this Policy</h2>
            <p>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] md:text-xs font-medium">
          <p className="text-muted-foreground">© {new Date().getFullYear()} PannaMaster Security Team</p>
          <p className="text-primary">Last updated: May 8, 2026</p>
        </div>
      </div>
    </div>
  )
