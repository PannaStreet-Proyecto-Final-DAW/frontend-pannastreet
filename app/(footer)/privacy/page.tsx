...
export default function PrivacyPage() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 md:px-28 animate-in fade-in duration-700">
      <Link
        href="/games"
      ...
      <div className="bg-card border border-border rounded-[2rem] p-8 md:px-16 lg:px-24 md:py-12 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-8 text-muted-foreground leading-relaxed text-[13px] md:text-[12px] lg:text-sm text-justify">
          <section>
          ...
          <section>
            <h2 className="text-base font-bold text-primary mb-2 uppercase italic tracking-tight">How We Use Your Data</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-primary mb-2 uppercase italic tracking-tight">Data Security & Storage</h2>
            <p>
          ...
          <section>
            <h2 className="text-base font-bold text-primary mb-2 uppercase italic tracking-tight">Changes to this Policy</h2>
            <p>
